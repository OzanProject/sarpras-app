        ...
        <div class="bg-secondary rounded h-100 p-4">
            ...
            <form action="{{ route('user.update', $user->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $user->is_approved ? 'Disetujui' : 'Menunggu' }}" disabled>
                    @if(!$user->is_approved)
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="password" name="password" placeholder="Biarkan kosong jika tetap">
                </div>
