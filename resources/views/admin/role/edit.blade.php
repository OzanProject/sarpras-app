        ...
        <div class="bg-secondary rounded p-4 h-100 shadow-sm border border-light">
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control" id="description" name="description" rows="4"
              placeholder="Deskripsi singkat tentang tanggung jawab atau fungsi hak akses ini...">{{ old('description', $role->description) }}</textarea>
            @error('description') 
              <div class="text-danger mt-1 small"><i class="fa fa-exclamation-circle me-1"></i>{{ $message }}</div> 
            @enderror
          </div>
      ...
      <div class="col-lg-7 col-xl-8">
        <div class="bg-secondary rounded p-4 h-100 shadow-sm border border-light">
          ...
          <p class="text-muted small mb-4">
            Sesuaikan izin akses di bawah ini sesuai dengan tugas dan tanggung jawab role ini.
          </p>
