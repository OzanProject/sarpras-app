...
<head>
    <meta charset="utf-8">
    <title>Lupa Password - {{ $global_settings['nama_sekolah'] ?? 'Sarana Prasarana' }}</title>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="auth-card my-4 mx-3">
                        <div class="auth-logo-container text-center mb-4">
                            ...
                            <h3 class="auth-title-text mt-3 mb-1">Lupa Password</h3>
                            <p class="text-muted mb-0" style="font-size: 0.85rem;">Atur ulang kata sandi akun Anda</p>
                        </div>
                        
                        <div class="mb-4 text-muted text-center" style="font-size: 0.85rem; line-height: 1.5;">
                            {{ __('Masukkan alamat email Anda yang terdaftar dan kami akan mengirimkan tautan pengaturan ulang password.') }}
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <button type="submit" class="btn btn-primary auth-btn-submit py-3 mb-4">
                                Kirim Link Reset <i class="fa fa-paper-plane ms-1"></i>
                            </button>
                            
                            <p class="text-center mb-0 text-muted" style="font-size: 0.875rem;">
                                <a href="{{ route('login') }}" style="color: #0ea5e9; font-weight: 600; text-decoration: none;"><i class="fa fa-arrow-left me-1" style="font-size: 0.75rem;"></i> Kembali ke Login</a>
                            </p>
                        </form>
                    </div>
                </div>
