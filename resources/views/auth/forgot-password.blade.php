...
<head>
    <meta charset="utf-8">
    <title>Forgot Password - {{ $global_settings['school_name'] ?? 'Sarana Prasarana' }}</title>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Kirim Link Reset Password</button>
